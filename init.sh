...
echo -e '\x1b[32mCreating directories:\x1b[0m'
mkdir www/media
mkdir www/media/Editor
mkdir app/runtime
mkdir app/Modules
cd app
echo -e '\x1b[32mInstalling composer:\x1b[0m'
...
RESULT=$?
rm composer-setup.php
echo -e '\x1b[32mInstalling vendors:\x1b[0m'
php composer.phar install --no-dev
echo -e '\x1b[32mInstalling phact modules:\x1b[0m'
cd Modules
...
cd ../../www/static
yarn
echo -e '\x1b[32mWell done!\x1b[0m'